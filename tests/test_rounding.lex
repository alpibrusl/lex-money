...
fn make_1255() -> d.Decimal {
  { coefficient: 1255, exponent: -3 }
}
...
fn suite() -> List[Result[Unit, Str]] {
  [test_round_half_up(), test_round_half_down(), test_round_down(), test_round_up(), test_round_ceiling(), test_round_floor(), test_no_op_same_exponent(), test_scale_up(), test_half_even_round_to_even(), test_half_even_round_up()]
}
